...
function authEnvironment() {
  const bindings = env as unknown as {
    JIMDUR_AUTH_SECRET?: string;
    JIMDUR_SETUP_CODE_HASH?: string;
    JIMDUR_PASSWORD_RECOVERY_CODE_HASH?: string;
    JIMDUR_PASSWORD_RECOVERY_USERNAME?: string;
    JIMDUR_PASSWORD_RECOVERY_EXPIRES_AT?: string;
  };
